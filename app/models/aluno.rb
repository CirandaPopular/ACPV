class Aluno < ApplicationRecord
  ...
  validates :contato_responsavel, presence: true, numericality: { only_integer: true, message: "deve conter apenas números" }, length: { minimum: 9, maximum: 14, too_short: "muito curto (o tamanho mínimo é %{count} caracteres)", too_long: "muito longo (o tamanho máximo é %{count} caracteres)" }
