...
When("Eu preencho com {string} o campo nome completo e preencho o campo idade com {string}") do |nome, idade|
...
When("Eu preencho o campo endereco com {string} e preencho o campo cidade com {string}") do |endereco, cidade|
  fill_in 'professor[endereco]', :with => endereco
  fill_in 'professor[cidade]', :with => cidade
end

When("Eu seleciono {string} no campo grau de instrucao e seleciono {string} no campo cidade para se voluntariar") do |grau, cidade_voluntario|
...
When("Eu seleciono {string} no campo disponibilidade e seleciono {string} no campo area de atuacao") do |disponibilidade, area_atuacao|
